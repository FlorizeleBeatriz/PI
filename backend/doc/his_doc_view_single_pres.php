                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-7">
                                                <div class="pl-xl-3 mt-3 mt-xl-0">
                                                    <h3 class="mb-3">Nome: <?php echo $row->pres_pat_name;?></h2>
                                                    <hr>
                                                    <h4 class="">Idade: <?php echo $row->pres_pat_age;?> Years</h3>
                                                    <hr>
                                                    <h4 class="">Número do Paciente: <?php echo $row->pres_pat_number;?></h3>
                                                    <hr>
                                                    <h4 class="align-centre">Prescription:</h2>
                                                    <hr>
