                                            ...
                                            <form method="post">
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <input required="required" type="text" readonly name="pres_pat_addr" value="<?php echo $row->pat_addr;?> <?php echo $row->pat_addrn;?>" class="form-control"  id="inputPassword4" placeholder="Patient`s Age">
                                                    </div>
