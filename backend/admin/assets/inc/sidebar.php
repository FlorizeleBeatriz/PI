                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li>
                                        <a href="his_admin_add_doc.php">Cadastrar Medico</a>
                                    </li>
                                    <li>
                                        <a href="his_admin_add_rece.php">Cadastrar Recepcionista</a>
                                    </li>
                                    <li>
                                        <a href="his_admin_add_farm.php">Cadastrar Farmaceutico</a>
                                    </li>
                                    <li>
                                        <a href="his_admin_add_teso.php">Cadastrar Tesoureiro</a>
                                    </li>
                                    <li>
                                        <a href="his_admin_view_employee.php">Visualizar Funcionários </a>
                                    </li>
                                    <li>
                                        <a href="his_admin_manage_employee.php">Gerir Funcionários</a>
                                    </li>
                                    <hr>
                                    <li>
                           ...
                           <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    ...
                                    <li>
                                        <a href="his_admin_add_single_presc.php">Add  single Prescriptions</a>
                                    </li>_
                                    <li>
