        ...
        <div class="content-page">
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div>
                        <div class="row m-1 d-flex justify-content-evenly">
                            <div class="col-3 alert alert-secondary m-2">
                                <div class="row">
                                    <div class="col-7">
                                        <h5>Total Medicos</h5>
                                        <h1>2</h1>
                                    ...
                                    <div class="col-5">
                                        <FontAwesomeIcon icon="fa-solid fa-user-doctor" class="img-fluid" />
                                    </div>
                                </div>

                                <div class="col-12 alert alert-warning">Total de medicos cadastrados</div>
                            </div>
                            <div class="col-3 alert alert-secondary m-2">
                                <div class="row">
                                    <div class="col-7">
                                    ...
                                    <div class="col-5">
                                        <FontAwesomeIcon icon="fa-solid fa-dollar-sign" class="img-fluid" />
                                    </div>
                                </div>
                                <div class="col-12">Valor Total do Mês</div>
                            </div>
                            <div class="col-3 alert alert-secondary m-2">
                                <div class="row">
                                    <div class="col-7">
                                    ...
                                    <div class="col-5">
                                        <FontAwesomeIcon icon="fa-solid fa-stethoscope" class="img-fluid" />
                                    </div>
                                </div>
                                <div class="col-12">Total de Consultas Agendadas</div>
                            </div>
                            ...
                            <div class="col-3 alert alert-secondary m-2">
                                <div class="row">
                                    <div class="col-7">
                                        ...
                                        $stmt->close();
                                        ?>
                                        <h1><span data-plugin="counterup"><?php echo $doc; ?></h1>
                                    </div>
                                    <div class="col-5">
                                    <i class="mdi mdi-doctor font-22 avatar-title text-primary"></i>
                                    </div>
                                </div>
                                <div class="col-12">Total de Funcionários Cadastrados</div>
                            </div>
                            ...
                            <div class="col-3 alert alert-secondary m-2">
                                <div class="row">
                                    ...
                                    <div class="col-5">
                                        <FontAwesomeIcon icon="fa-solid fa-notes-medical" class="img-fluid" />
                                    </div>
                                </div>
                                <div class="col-12">Total de Consultas no Mês</div>
                            </div>
