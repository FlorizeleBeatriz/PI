...
check_login();
$teso_id = $_SESSION['teso_id'];
$teso_fname = $_SESSION['teso_fname'];
        ...
        <div class="content-page">
            <div class="content">
                ...
                <div class="container-fluid">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="text-right">
                                            ...
                                            $stmt->close();
                                            ?>
                                            <h3><span data-plugin="counterup"><?php echo $doc; ?></h>
                                            <p class="text-muted mb-1 text-truncate"> Funcionários</p>
                                        </div>
                                    </div>
                                </div> <!-- end row-->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="text-right">
                                            <?php
                                            /* 
                                                     * code for summing up fname of assets,
                                                     */
                                    ...
                                    <div class="col-6">
                                        <div class="text-right">
                                            ...
                                            /* 
                                                     ...
                                                     */
                                            $result = "SELECT count(*) FROM his_payrolls ";
                                            $stmt = $mysqli->prepare($result);
                                            $stmt->execute();
                                            ...
                                            $stmt->close();
                                            ?>
                                            <h3 class="text-dark mt-1"><span data-plugin="counterup"><?php echo $payrolls; ?></span></h3>
                                            <p class="text-muted mb-1 text-truncate">Pagamentos</p>
                                        </div>
                                    </div>
                                </div> <!-- end row-->
                            </div> <!-- end widget-rounded-circle-->
                    ...
                    <!--tesontly Employed Employees-->
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card-box">
                                <h4 class="header-title mb-3">Pagamentos</h4>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-borderless table-hover table-centered m-0">
                                        ...
                                        <?php
                                        $ret = "SELECT * FROM his_payrolls ORDER BY RAND() LIMIT 100 ";
                                        //sql code to get to ten tesos  randomly
                                        ...
                                        ?>
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php echo $row->pay_doc_name; ?>
                                                    </td>
                                                    <td>
                                                        <?php echo $row->pay_doc_email; ?>
                                                    </td>
                                                    <td>
                                                        <?php echo $row->pay_doc_number ?>
                                                    </td>
                                                    <td>
                                                        <?php echo $row->pay_emp_salary; ?>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        <?php } ?>
