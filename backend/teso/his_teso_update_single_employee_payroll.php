                                    ...
                                    <div class="page-title-box">
                                        <div class="page-title-right">
                                            <ol class="breadcrumb m-0">
                                                ...
                                                <li class="breadcrumb-item active">Atualizar registo da folha de pagamento de Funcionário</li>
                                            </ol>
                                        </div>
                                        <h4 class="page-title">Atualizar registo da folha de pagamento de Funcionário
                </h4>
                                    </div>
                                </div>
                            </div>     
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form method="post">
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        <label for="inputPassword4" class="col-form-label">Email do Funcionário</label>
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        <label for="inputPassword4" class="col-form-label">Contacto do Funcionário</label>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="inputEmail4" class="col-form-label">Salário do Funcionário (MZN)</label>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                    <label for="inputState" class="col-form-label">Status do Pagamento</label>
