                                    ...
                                    <div class="page-title-box">
                                        <div class="page-title-right">
                                            <ol class="breadcrumb m-0">
                                                ...
                                                <li class="breadcrumb-item active">Gerar Pagamentos</li>
                                            </ol>
                                        </div>
                                    ...
                                    <div class="card-box">
                                        ...
                                        <div class="clearfix">
                                            ...
                                            <div class="float-right">
                                                <h4 class="m-0 d-print-none"><?php echo $row->pay_doc_name;?> Pagamentos</h4>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 offset-md-2">
                                                <div class="mt-3 float-right">
                                                    <p class="m-b-10"><strong>Data de Pagamento: </strong> <span class="float-right"> &nbsp;&nbsp;&nbsp;&nbsp; <?php echo date("d-m-Y - h:m:s", strtotime($mysqlDateTime));?> </span></p>
                                                    <p class="m-b-10"><strong>Status do Pagamento: </strong> <span class="float-right"><span class="badge badge-success"><?php echo $row->pay_status;?></span></span></p>
                                                    <p class="m-b-10"><strong>Número de pagamento: </strong> <span class="float-right"><?php echo $row->pay_number;?></span></p>
                                                    <p class="m-b-10"><strong>Número do Funcionário: </strong> <span class="float-right"><?php echo $row->pay_doc_number;?></span></p>
