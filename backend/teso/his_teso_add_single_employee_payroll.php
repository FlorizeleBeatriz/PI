                                    ...
                                    <div class="page-title-box">
                                        <div class="page-title-right">
                                            <ol class="breadcrumb m-0">
                                                <li class="breadcrumb-item"><a href="his_teso_dashboard.php">Dashboard</a></li>
                                                <li class="breadcrumb-item"><a href="javascript: void(0);">Pagamentos</a></li>
                                                <li class="breadcrumb-item active">Adicionar registo de pagamento</li>
                                            </ol>
                                        </div>
                                        <h4 class="page-title">Adicionar registo de pagamento</h4>
                                    </div>
                                </div>
                            </div>     
                            <!-- end page title --> 
                                            ...
                                            <form method="post">
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        <label for="inputEmail4" class="col-form-label">Nome do Funcionário</label>
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        <label for="inputPassword4" class="col-form-label">Número do Funcionário</label>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        <label for="inputEmail4" class="col-form-label">Salário do Funcionário($)</label>
                                                        <input type="text" required="required"  readonly name="pay_emp_salary" value="<?php echo $row->doc_salary;?>"  class="form-control" id="inputEmail4" >
                                                    </div>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-2" style="display:none">
                                                        ...
                                                        ?>
                                                        <label for="inputZip" class="col-form-label">Número do registo de Pagamento</label>
                                                        <input type="text" name="pay_number" value="<?php echo $pay_no;?>" class="form-control" id="inputZip">
                                                    </div>
                                                </div>
                                                
                                                <div class="form-group">
                                                        <label for="inputAddress" class="col-form-label">Descrição do Pagamento</label>
                                                        <textarea   type="text" class="form-control" name="pay_descr" id="editor"> </textarea>
                                                </div>

                                                <button type="submit" name="add_payroll" class="ladda-button btn btn-primary" data-style="expand-right">Adicionar Pagamento</button>
