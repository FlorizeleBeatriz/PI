                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Cadastrar Medicamento</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                        ...
                                        <form method="post">
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    <label for="inputEmail4" class="col-form-label">Nome do Medicamento</label>
                                                    <input type="text" required="required" name="phar_name" class="form-control" id="inputEmail4" >
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="inputPassword4" class="col-form-label">Quantidade(Cartons)</label>
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label for="inputState" class="col-form-label">Fornecedor</label>
                                            ...
                                            <div class="form-group">
                                                    <label for="inputPassword4" class="col-form-label">Código de Barra(EAN-8)</label>
                                                    <?php 
                                                        $length = 10;    
                                           ...
                                           <button type="submit" name="add_pharmaceutical" class="ladda-button btn btn-success" data-style="expand-right">Cadastrar Medicamento</button>
