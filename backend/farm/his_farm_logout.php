                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p class="text-white-50">Voltar para<a href="index.php" class="text-white ml-1"><b>Log In</b></a> Ou<a href="../../index.php" class="text-white ml-1"><b>HomePage</b></a></p>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
