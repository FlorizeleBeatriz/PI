                                    ...
                                    <div class="page-title-box">
                                        <div class="page-title-right">
                                            <ol class="breadcrumb m-0">
                                                ...
                                                <li class="breadcrumb-item active">Visualizar Medicamentos</li>
                                            </ol>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-7">
                                                <div class="pl-xl-3 mt-3 mt-xl-0">
                                                    <h2 class="mb-3">Nome Medicamento: <?php echo $row->phar_name;?></h2>
                                                    <hr>
                                                    <h4 class="text-danger">Fornecedor: <?php echo $row->phar_vendor;?></h4>
                                                    <hr>
                                                    <h4 class="text-danger">Quantidade: <?php echo $row->phar_qty;?> Cartons</h4>
                                                    <hr>
                                                    ...
                                                    <form class="form-inline mb-4">
                                                        <label class="my-1 mr-2" for="quantityinput">Quantidade</label>
                                                    ...
                                                    <div>
                                                        ...
                                                        <button type="button" class="btn btn-success waves-effect waves-light">
                                                            <span class="btn-label"><i class="mdi mdi-cart"></i></span>Adicionar ao carrinho
                                                        </button>
                                                    </div> 
                                                </div>
                                            </div> <!-- end col -->
