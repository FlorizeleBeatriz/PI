...
<hr>
                ...
                <li>
                    <a href="his_rece_register_patient.php">
                        <i class="fas fa-user-plus"></i>
                        <span> Registar Paciente </span>
                    </a>
                </li>
                <li>
                    <a href="his_rece_view_patients.php">
                        <i class="fas fa-user-check"></i>
                        <span> Visualizar Paciente </span>
                    </a>
                </li>
                <li>
                    <a href="his_rece_manage_patient.php">
                ...
                <li>
                    <a href="his_rece_manage_cons_patients.php">
                        <i class="fas fa-user-check"></i>
