...
if (isset($_POST['update_patient'])) {
    ...
    $query = "UPDATE  his_patients  SET pat_fname=?, pat_lname=?, pat_age=?, pat_addr=?, pat_addrn=?,pat_phone=?  WHERE pat_id = ?";
    $stmt = $mysqli->prepare($query);
    $rc = $stmt->bind_param('issssss', $pat_id, $pat_fname, $pat_lname, $pat_age, $pat_addr, $pat_addrn, $pat_phone );
    $stmt->execute();
    /*
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">Ataulizar Dados do Pacientes</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                            ...
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="form-group col-md-4">
                                        <label for="inputAddress" class="col-form-label">Número do Endereço</label>
                                        <input required="required" type="text" value="<?php echo $row->pat_addrn; ?>" class="form-control" name="pat_addrn" id="inputAddress" placeholder="Patient's Addresss number">
                                    </div>
                                    ...
                                    <button type="submit" name="update_patient" class="ladda-button btn btn-success" data-style="expand-right">Adicionar Alterações</button>
