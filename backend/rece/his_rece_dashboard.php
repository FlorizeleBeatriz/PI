                    ...
                    <div class="container-fluid">
                        ...
                        <!--Start Vendors-->
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <div class="text-right">
                                                    ...
                                                    <p class="text-muted mb-1 text-truncate">Meu Perfil</p>
                                                </div>
                                            </div>
                                        </div> <!-- end row-->
                                    </div>
                           ...
                           <!-- end col--> 
                            ...
                            <div class="col-md-6 col-xl-6">
                                <a href="his_rece_view_payrolls.php">
                                    <div class="widget-rounded-circle card-box">
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="avatar-lg rounded-circle bg-soft-danger border-danger border">
                                            ...
                                            <div class="col-6">
                                                <div class="text-right">
                                                    <h3 class="text-dark mt-1"></span></h3>
                                                    <p class="text-muted mb-1 text-truncate">Meus pagamentos</p>
                                                </div>
                                            </div>
                                        </div> <!-- end row-->
                                    </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-borderless table-hover table-centered m-0">
                                            ...
                                            <?php
                                                ...
                                                //sql code to get to ten reces  randomly
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php echo $row->pat_age;?> Anos
                                                    </td>
                                                    <td>
                                                        <?php echo $row->pat_addr;?>
                                                    </td>   
                                                     <td>
                                                        <?php echo $row->pat_addrn;?>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <a href="his_rece_view_single_patient.php?pat_id=<?php echo $row->pat_id;?>>&&pat_name=<?php echo $row->pat_fname;?>_<?php echo $row->pat_lname;?>" class="btn btn-xs btn-success"><i class="mdi mdi-eye"></i> View</a>
                                                    </td>                                                                                                                                                                                                                                                                                         
                                                </tr>
                                            </tbody>
                                            <?php }?>
