                            ...
                            ?>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><?php echo $row->pat_age; ?> Anos</td>

                                        <td><a href="his_rece_view_single_patient.php?pat_id=<?php echo $row->pat_id; ?>&&pat_name=<?php echo $row->pat_fname; ?><?php echo $row->pat_lname; ?>" class="badge badge-success"><i class="mdi mdi-eye"></i> View</a>
                                        <a href="his_rece_add_cons.php?pat_number=<?php echo $row->pat_number; ?>" class="badge badge-success"> Add cons</a>
                                        </td>
                                    </tr>
                                </tbody>
                            <?php $cnt = $cnt + 1;
