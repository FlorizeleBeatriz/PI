<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['add_patient']))
		{
            ...
            $pat_addr=$_POST['pat_age']; 
            $pat_age = $_POST['pat_addr'];
            $pat_addrn=$_POST['pat_addrn'];
            $pat_phone=$_POST['pat_phone'];
            //sql to insert captured values
			$query="insert into his_patients (`pat_fname`, `pat_lname`, `pat_age`, `pat_addr`,`pat_addrn`, `pat_phone`) values(?,?,?,?,?,?)";
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('ssssss', $pat_fname, $pat_lname,  $pat_age, $pat_addr, $pat_addrn, $pat_phone);
			$stmt->execute();
			/*
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    <label for="inputPassword4" class="col-form-label">Bairro</label>
                                                    <input required="required" type="text" name="pat_age" class="form-control"  id="inputPassword4" placeholder="Bairro">
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <label for="inputAddress" class="col-form-label">Idade</label>
                                                <input required="required" type="text" class="form-control" name="pat_addr" id="inputAddress" placeholder="Idade do Paciente">
                                            </div>
