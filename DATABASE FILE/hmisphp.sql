-- phpMyrecemin SQL Dump
-- version 4.6.5.2
-- https://www.phpmyrecemin.net/
--
-- Host: 127.0.0.1
...
--
-- Table structure for table `his_recemin`
--
...
CREATE TABLE `his_rece` (
  `rece_id` int(20) NOT NULL,
  `rece_fname` varchar(200) DEFAULT NULL,
  `rece_lname` varchar(200) DEFAULT NULL,
  `rece_email` varchar(200) DEFAULT NULL,
  `rece_number` varchar(200) DEFAULT NULL,
  `rece_pwd` varchar(200) DEFAULT NULL,
  `rece_dpic` varchar(200) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
CREATE TRIGGER tr_insert_rece_funcionarios
AFTER INSERT ON his_rece
FOR EACH ROW
BEGIN
    INSERT INTO 'funcionarios' ('fnumber', 'nome', 'tipo')
    VALUES (NEW.rece_number, CONCAT(NEW.rece_number, ' ', NEW.rece_fname), 'Recepcionista');
END;
--
-- Dumping data for table `his_rece`
--

INSERT INTO `his_rece` (`rece_id`, `rece_fname`, `rece_lname`, `rece_email`, `rece_number`, `rece_pwd`, `rece_dpic`) VALUES
(2, 'Bela', 'Joao', 'belajoao@gmail.com','', '4c7f5919e957f354d57243d37f223cf31e9e7181','');

-- --------------------------------------------------------

CREATE TABLE `his_farm` (
  `farm_id` int(20) NOT NULL,
  `farm_fname` varchar(200) DEFAULT NULL,
  `farm_lname` varchar(200) DEFAULT NULL,
  `farm_email` varchar(200) DEFAULT NULL,
  `farm_number` varchar(200) DEFAULT NULL,
  `farm_pwd` varchar(200) DEFAULT NULL,
  `farm_dpic` varchar(200) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
CREATE TRIGGER tr_insert_farm_funcionarios
AFTER INSERT ON his_farm
FOR EACH ROW
BEGIN
    INSERT INTO 'funcionarios' ('fnumber', 'nome', 'tipo')
    VALUES (NEW.farm_number, CONCAT(NEW.farm_number, ' ', NEW.farm_fname), 'Farmaceutico');
END;
--
-- Dumping data for table `his_`
--

INSERT INTO `his_farm` (`farm_id`, `farm_fname`, `farm_lname`, `farm_email`, `farm_number`, `farm_pwd`) VALUES
(1, 'Bela', 'Joseph', 'belajoseph@gmail.com', '12345');
--
CREATE TABLE `his_teso` (
  `teso_id` int(20) NOT NULL,
  `teso_fname` varchar(200) DEFAULT NULL,
  `teso_lname` varchar(200) DEFAULT NULL,
  `teso_email` varchar(200) DEFAULT NULL,
  `teso_number` varchar(200) DEFAULT NULL,
  `teso_pwd` varchar(200) DEFAULT NULL,
  `teso_dpic` varchar(200) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
DELIMITER //
CREATE TRIGGER tr_insert_teso_funcionarios
AFTER INSERT ON his_teso
FOR EACH ROW
BEGIN
    INSERT INTO 'funcionarios' ('fnumber', 'nome', 'tipo')
    VALUES (NEW.teso_number, CONCAT(NEW.teso_number, ' ', NEW.teso_fname), 'Tesoureiro');
END;
//
DELIMITER ;
--
...
INSERT INTO `his_teso` (`teso_id`, `teso_fname`, `teso_lname`, `teso_email`, `teso_number`, `teso_pwd`) VALUES
(1, 'Maria', 'Machoco', 'belajoao@gmail.com', '','','user-default-2-min.png');
...
CREATE TRIGGER tr_insert_doc_funcionarios
AFTER INSERT ON his_docs
FOR EACH ROW
BEGIN
    INSERT INTO 'funcionarios' ('fnumber', 'nome', 'tipo')
    VALUES (NEW.doc_number, CONCAT(NEW.doc_number, ' ', NEW.doc_fname), 'Medico');
END;
--
...
(3, 'John Doe', 'Malaria', 'RAV6C', '<p><strong>Pain areas: </strong>in the abdomen or muscles</p><p><strong>Whole body: </strong>chills, fatigue, fever, night sweats, shivering, or sweating</p><p><strong>Gastrointestinal: </strong>diarrhoea, nausea, or vomiting</p><p><strong>Also common: </strong>fast heart rate, hereceache, mental confusion, or pallor</p>', '<p><strong>Pain areas: </strong>in the abdomen or muscles -Tested Positive</p><p><strong>Whole body: </strong>chills, fatigue, fever, night sweats, shivering, or sweating - Tested Positive</p><p><strong>Gastrointestinal: </strong>diarrhoea, nausea, or vomiting - Tested Positive</p><p>&nbsp;</p>', '90ZNX', '2020-01-13 12:31:48'),
...
CREATE TABLE `his_medical_records` (
  ...
  `mdr_pat_recer` varchar(200) DEFAULT NULL,
...
INSERT INTO `his_medical_records` (`mdr_id`, `mdr_number`, `mdr_pat_name`, `mdr_pat_recer`, `mdr_pat_age`, `mdr_pat_ailment`, `mdr_pat_number`, `mdr_pat_prescr`, `mdr_date_rec`) VALUES
...
(3, 'F1ZHQ', 'Michael White', '60 Rreceford Street', '30', 'Demo Test', 'DCRI8', NULL, '2022-10-18 17:08:35.7938'),
...
CREATE TABLE `his_patients` (
  ...
  `pat_addrn` varchar(200) DEFAULT NULL,
...
INSERT INTO `his_patients` (`pat_id`, `pat_fname`, `pat_lname`, `pat_age`,`pat_addr`,  `pat_addrn`, `pat_phone`) VALUES
(8, 'Michael', 'White',  '30', 'Rreceford Street', '60 ', '1458887854'),
(9, 'Lawrence', 'Bischof', '32', 'Bryan Street', '82 ', '7412225698'),
(10, 'Cynthia', 'Connolly', '22', 'Hill Haven Drive', '9', '1478885458'),
(11, 'Helen', 'Macdougall',  '42', 'Holly Street', '28 ', '1458889655'),
(12, 'Christine', 'Moore',  '28', 'Bleecker Street', '117 ', '7412569698');
...
CREATE TABLE `his_prescriptions` (
  ...
  `pres_pat_recedr` varchar(200) DEFAULT NULL,
...
CREATE TABLE `his_vendor` (
  ...
  `v_recer` varchar(200) DEFAULT NULL,
...
INSERT INTO `his_vendor` (`v_id`, `v_number`, `v_name`, `v_recer`, `v_mobile`, `v_email`, `v_phone`, `v_desc`) VALUES
(1, '6ISKC', 'Cosmos Pharmaceutical Limited', 'P.O. Box 41433, GPO 00100 Nairobi, Kenya', '', 'info@cosmospharmaceuticallimited.com', '+254(20)550700-9', '<p>Lorem ipsum dolor sit amet, consectetuer receipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem. Nulla consequat massa quis enim. Donec pede justo, fringilla vel, aliquet nec, vulputate eget, arcu. In enim justo, rhoncus ut, imperdiet a, venenatis vitae, justo. Nullam dictum felis eu pede mollis pretium. Integer tincidunt. Cras dapibus. Vivamus elementum semper nisi. Aenean vulputate eleifend tellus. Aenean leo ligula, porttitor eu, consequat vitae, eleifend ac, enim. Aliquam lorem ante, dapibus in, viverra quis, feugiat a, tellus. Phasellus viverra nulla ut metus varius laoreet. Quisque rutrum. Aenean imperdiet. Etiam ultricies nisi vel augue. Curabitur ullamcorper ultricies nisi. Nam eget dui. Etiam rhoncus. Maecenas tempus, tellus eget condimentum rhoncus, sem quam semper libero, sit amet receipiscing sem neque sed ipsum. Nam quam nunc, blandit vel, luctus pulvinar, hendrerit id, lorem. Maecenas nec odio et ante tincidunt tempus. Donec vitae sapien ut libero venenatis faucibus. Nullam quis ante. Etiam sit amet orci eget eros faucibus tincidunt. Duis leo. Sed fringilla mauris sit amet nibh. Donec sodales sagittis magna. Sed consequat, leo eget bibendum sodales, augue velit cursus nunc,</p>');
...
--
-- AUTO_INCREMENT for table `his_recemin`
--
ALTER TABLE `his_recemin`
  MODIFY `rece_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
